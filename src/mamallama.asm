...
s0F40   .BYTE $8D,$24,$6D,$4C,$08,$0F,$FF,$5B
...
s103F   .BYTE $A2,$07,$BD,$C7,$07,$9D,$33,$10
...
s465D   LDA $D01D    ;Sprites Expand 2x Horizontal (X)
        ORA a27
...
s498A   JSR ROM_SCNKEY ;$FF9F - scan keyboard                    
        JSR s66A8
        LDA aC5
        CMP #$03
        BEQ b499E
...
a4A41   .BYTE $00
j4A42   LDA $D016    ;VIC Control Register 2
        AND #$E0
        ORA #$08
        STA $D016    ;VIC Control Register 2
        LDA a05
...
s4F01   JSR ROM_SCNKEY ;$FF9F - scan keyboard                    
        JSR s66A8
        LDA aC5
        CMP #$04
        BNE b4F10
...
b5BE3   LDA f5CA4,X
        ...
        TAY 
        LDA f5E54,Y
j5BEC   STA $D027,X  ;Sprite 0 Color
        LDA f5C88,X
        ORA a5DDB
        STA a5DDB
        LDA f5C8C,X
...
s6442   STA $D40F    ;Voice 3: Frequency Control - High-Byte
        LDA #$08
        STA $D412    ;Voice 3: Control Register
        LDA #$30
        STA a6731
